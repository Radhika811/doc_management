...
SECRET_KEY = 'django-insecure-!8a&^h*qjtuv#f6)uo*=gl@io7di-gar*-*_#^_=nsn4n1b-or'
...
DATABASES = {
    'default': {
        ...
        'USER': 'radhika',
        'PASSWORD': 'password',
        'HOST': 'localhost',  # Use 'localhost' if your database is on the same machine, or provide the hostname or IP address
